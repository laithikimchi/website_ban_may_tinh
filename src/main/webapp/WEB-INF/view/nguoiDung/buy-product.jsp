    ...
    <div class="row bg-light">
        ...
        <div class="p-4 col-5">
            <form action="/order/save" method="post">
                <div class="mb-3">
                    <input type="text" placeholder="Họ tên" class="form-control" name="recipientName"/>
                </div>
                <div class="mb-3">
                    <input type="text" placeholder="Số điện thoại" class="form-control" name="phoneAddress"/>
                </div>
                <div class="mb-3">
                    <input type="text" placeholder="Địa chỉ" class="form-control" name="shippingAddress"/>
                </div>
