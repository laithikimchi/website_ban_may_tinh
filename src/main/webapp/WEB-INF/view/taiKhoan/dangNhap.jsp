...
<head>
    ...
    <div class="container">
        <div class="row ">
            <form action="/login" class="col-md-6 col-sm-8 offset-sm-3" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="" class="form-control" required type="password" name="password">
                </div>
                <div class="d-flex">
                    <input type="submit" value="Đăng nhập" class="btn-primary btn btn-block">
                    <a href="/doi-mk"  class="btn-danger btn btn-block"> Quen MK</a>
                </div>
            </form>
        </div>
    </div>
